#!/usr/bin/env python3
"""
slides-bn.py - parchment design system, Bengali slide deck generator.

Usage:
  pip install python-pptx --break-system-packages
  python3 slides-bn.py

Output:
  output.pptx (16:9, parchment aesthetic, Noto Serif Bengali)
...
# Bengali font stack. PowerPoint falls back silently if the
...
def main():
    ...
    cover_slide(prs,
        title="{{ডকুমেন্ট শিরোনাম}}",
        subtitle="{{এক লাইনের বিবরণ।}}",
        author="{{লেখক}}",
        date="২০২৬.০৪")
    ...
    chapter_slide(prs, 1, "{{অধ্যায়ের শিরোনাম}}")

    content_slide(prs,
        eyebrow="{{অধ্যায় · এই পৃষ্ঠা}}",
        title="{{একটি বাক্যে মূল দাবি}}",
        body=("{{একটি ছোট বডি প্যারাগ্রাফ। এটি তিন লাইনের নিচে রাখুন। "
              "একটি স্লাইড, একটি মূল ধারণা। পাঠকের মনোযোগ একটি দুষ্প্রাপ্য সম্পদ।}}"),
        page_num=5)
    ...
    metrics_slide(prs,
        ...
        metrics=[
            ("+৪২%",   "রূপান্তর বৃদ্ধি"),
            ("৩.৮M",   "মাসিক সক্রিয় ব্যবহারকারী"),
            ("৯৯.৯%",  "সিস্টেম প্রাপ্যতা"),
            ("৫,০০০+", "সর্বোচ্চ ট্র্যাফিক"),
        ])

    quote_slide(prs,
        quote="ভালো ডিজাইন হলো যতটা সম্ভব কম ডিজাইন।",
        source="ডিয়েটার রামস")

    ending_slide(prs,
        message="ধন্যবাদ",
        contact="{{ইমেইল}} · {{ওয়েবসাইট}}")
